...
void SetupImages(Rikishi* fighter1, Rikishi* fighter2, TForm *form) {
	...
	BattleForm->TextChat1->Visible = false;
	BattleForm->TextChat2->Visible = false;
...
//		PopulateLeaderboardGrid();
	...
	case 1:
		...
		BattleForm->TextChat1->Text = "I invoke my tanacity!";
		BattleForm->TextChat2->Text = "I invoke my agility!";
